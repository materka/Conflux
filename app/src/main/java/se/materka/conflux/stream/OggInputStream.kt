package se.materka.conflux.stream
 ...
 *
 */
internal class OggInputStream(stream: InputStream, private val listener: ShoutcastStreamListener) : PeekInputStream(stream) {
    ...
    private inner class CommentHeader(
        ...
        fun unpack(scratch: ParsableByteArray, listener: ShoutcastStreamListener) {
